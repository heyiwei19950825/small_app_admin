...
CREATE TABLE `lr_admin_app` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3058 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='小程序信息配置';
...
-- ----------------------------
-- Table structure for lr_ad_category
-- ----------------------------
DROP TABLE IF EXISTS `lr_ad_category`;
CREATE TABLE `lr_ad_category` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '广告分类名称',
...
-- ----------------------------
-- Records of lr_ad_category
-- ----------------------------
INSERT INTO `lr_ad_category` VALUES ('1', '首页Banner广告', '小程序顶部banner轮播图广告展示位', '1510481421');
INSERT INTO `lr_ad_category` VALUES ('5', '首页精选广告', '精选列表下方广告', '1510482074');
...
CREATE TABLE `lr_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='商品属性';
...
CREATE TABLE `lr_brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='品牌街';

-- ----------------------------
-- Records of lr_brand
-- ----------------------------
INSERT INTO `lr_brand` VALUES ('1', '肉擒类', 'UploadFiles/brand/20170630/1498818446765084.jpg', '1', '1493177975', '0');
...
CREATE TABLE `lr_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='分类';

-- ----------------------------
-- Records of lr_category
-- ----------------------------
INSERT INTO `lr_category` VALUES ('1', '0', '产品分类（系统分类，不要删除）', '0', '0', '', '', null, '', '0', null);
INSERT INTO `lr_category` VALUES ('2', '1', '手机', '1', '1493188517', '手机', 'UploadFiles/brand/20170630/1498818537250741.jpg', '1', null, '0', null);
...
INSERT INTO `lr_category` VALUES ('8', '2', '红米', '1', '1494211044', '红米手机最牛逼，我的最爱', 'UploadFiles/category/20170630/1498816164528404.png', '1', null, '0', null);
...
CREATE TABLE `lr_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='课程';
...
CREATE TABLE `lr_fankui` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='反馈';
...
CREATE TABLE `lr_group_joins` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='团购';
...
CREATE TABLE `lr_guanggao` (
  ...
  `type` enum('goods','category','special','index') DEFAULT 'index' COMMENT '广告类型',
  `action` varchar(255) NOT NULL COMMENT '链接值',
  `url` varchar(255) NOT NULL COMMENT '广告位跳转地址',
  `url_note` varchar(255) DEFAULT NULL COMMENT '跳转地址说明',
  `position` tinyint(2) unsigned DEFAULT '1' COMMENT '广告位置 1首页轮播',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='广告 轮播图';

-- ----------------------------
-- Records of lr_guanggao
-- ----------------------------
INSERT INTO `lr_guanggao` VALUES ('2', '滚动广告图2', 'UploadFiles/adv/20170524/1495589027693993.jpg', '0', '2', '', '', 'www.baidu.com', null, '5');
INSERT INTO `lr_guanggao` VALUES ('5', '首页轮播', 'UploadFiles/adv/20170525/1495684434521009.jpg', '0', '3', '', '', 'www.baidu.com', null, '1');
INSERT INTO `lr_guanggao` VALUES ('9', '首页轮播', 'UploadFiles/adv/20170524/1495589261959572.jpg', '0', '1', '', '', 'www.baidu.com', null, '1');
INSERT INTO `lr_guanggao` VALUES ('10', '首页轮播', 'UploadFiles/adv/20170524/1495588800716222.jpg', '1493349922', '4', '', '', 'www.baidu.com', null, '1');
INSERT INTO `lr_guanggao` VALUES ('12', '奥术大师', 'UploadFiles/adv/20171112/1510483078160246.png', '1510483078', '0', '', '阿斯达四大', 'www.baidu.com', null, '1');
INSERT INTO `lr_guanggao` VALUES ('19', 'asdasd', 'UploadFiles/adv/20171112/1510485489554666.png', '1510485489', '0', 'category', '2', 'http://test.1.com/index.php/Api/Product/lists?cat_id=2', '跳转到分类 ——手机', '1');
INSERT INTO `lr_guanggao` VALUES ('18', 'asdasd', 'UploadFiles/adv/20171112/1510485476810682.png', '1510485476', '123', 'index', '123', '', null, '1');
...
CREATE TABLE `lr_guige` (
  ...
  `addtime` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品规格';
...
CREATE TABLE `lr_hot` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='团购商品';
...
CREATE TABLE `lr_indeximg` (
  ...
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='图片';
...
CREATE TABLE `lr_news` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文章';
...
CREATE TABLE `lr_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单信息';

-- ----------------------------
-- Records of lr_order
-- ----------------------------
INSERT INTO `lr_order` VALUES ('1', '2527542452', '242542563653', '1', '1', '20.00', '20.00', '1493342432', '1', 'weixin', '0.00', '20', '0', 'eer', '13454565656', '问问投入法国恢复大飞哥', '0', null, null, '', '1', null, null, null, '2', '朔方南街', '1493344432', '1');
INSERT INTO `lr_order` VALUES ('2', '2017050810256495', null, '0', '1', '0.10', '0.10', '1494212943', '0', 'weixin', '0.00', '20', '0', '小程序', '13422334455', '吉林省 白山市 江源区 胜多负少的想法地方小高层上大学非常棒', '220605', '0', 'aaaa', '', '1', null, '顺丰快递', '43214321423', '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('3', '2017051010257975', null, '39', '1', '114.50', '0.00', '1494408303', '0', 'weixin', '0.00', '10', '2', '传承', '13699887744', '吉林省 通化市 二道江区 阿虎地方可能卡萨丁你', '220503', '0', '测试', '', '14', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('4', '2017052556525397', null, '48', '1', '9.00', '9.00', '1495710472', '0', 'weixin', '0.00', '10', '0', '传承', '13699887744', '吉林省 通化市 二道江区 阿虎地方可能卡萨丁你', '220503', '0', '哈哈', '', '1', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('5', '2017052652101575', null, '0', '1', '470.00', '470.00', '1495782164', '0', 'weixin', '0.00', '10', '0', '小小', '13455882266', '浙江省 丽水市 莲都区 什么街道什么路什么号什么附近', '331102', '0', '235', '', '2', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('6', '2017110950555110', null, '0', '1', '72.00', '72.00', '1510211490', '0', 'weixin', '0.00', '10', '0', '小小', '13455882266', '浙江省 丽水市 莲都区 什么街道什么路什么号什么附近', '331102', '0', '', '', '1', null, null, null, '0', null, '0', '1');
INSERT INTO `lr_order` VALUES ('7', '2017111250100515', null, '0', '1', '136.00', '136.00', '1510493762', '0', 'weixin', '0.00', '10', '0', '小花妹妹', '15324466594', '广东省 广州市 白云区 白云大道北的楷模符合你', '440111', '0', '', '', '2', null, null, null, '0', null, '0', '1');
...
CREATE TABLE `lr_order_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单展示信息';
...
INSERT INTO `lr_order_product` VALUES ('3', '272', null, '3', '不是开心果 胜似开心果', '2.00', 'UploadFiles/product/20170508/1494231242827074.jpg', '', '1494408303', '6', '');
INSERT INTO `lr_order_product` VALUES ('4', '274', null, '3', '给自己一个惊喜，给世界一个惊喜', '15.00', 'UploadFiles/product/20170428/1493342431423135.jpg', '', '1494408303', '1', '');
INSERT INTO `lr_order_product` VALUES ('5', '269', null, '3', '国外进口 还是熟悉的饼干味', '12.50', 'UploadFiles/product/20170508/1494231776498205.jpg', '', '1494408303', '7', '');
INSERT INTO `lr_order_product` VALUES ('6', '264', null, '4', '过去，平淡无奇；而未来，却多姿多彩', '9.00', 'UploadFiles/product/20170508/1494234169630484.jpg', '', '1495710472', '1', '');
INSERT INTO `lr_order_product` VALUES ('7', '269', null, '5', '雷米高狗粮成犬 澳宝 德牧边牧苏牧阿拉斯加哈士奇20kg 金毛狗粮', '235.00', 'UploadFiles/product/20170526/1495777671397934.jpg', '', '1495782164', '2', '');
INSERT INTO `lr_order_product` VALUES ('8', '279', null, '6', '贵宾狗粮E冠雷米高狗粮成犬泰迪狗粮小型犬天然粮2.5kg包邮', '72.00', 'UploadFiles/product/20170526/1495760445110489.jpg', '', '1510211490', '1', '');
INSERT INTO `lr_order_product` VALUES ('9', '279', null, '7', '贵宾狗粮E冠雷米高狗粮成犬泰迪狗粮小型犬天然粮2.5kg包邮', '72.00', 'UploadFiles/product/20170526/1495760445110489.jpg', '', '1510493762', '1', '');
INSERT INTO `lr_order_product` VALUES ('10', '288', null, '7', '小米无线鼠标', '64.00', 'UploadFiles/product/20170630/1498823998129871.jpg', '', '1510493762', '1', '');
...
CREATE TABLE `lr_post` (
  ...
  `pid` int(11) NOT NULL DEFAULT '0' COMMENT '商品ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='快递信息';
...
CREATE TABLE `lr_product` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=289 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品信息';
...
CREATE TABLE `lr_product_dp` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品评论';

-- ----------------------------
-- Records of lr_product_dp
-- ----------------------------
INSERT INTO `lr_product_dp` VALUES ('1', '16', '157', '0', '10', '非常好', '1470212647', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('2', '16', '159', '0', '10', '口感非常好，野生即食很方便', '1470223379', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('3', '41', '259', '0', '10', '功能强大，好评！', '1477715118', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('4', '41', '168', '0', '10', '居家养老好帮手，高科技产品，很好用！', '1477715176', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('5', '42', '155', '0', '10', '好评', '1479596161', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('6', '42', '168', '0', '10', '好评', '1479596179', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('7', '42', '162', '0', '10', '不错', '1479596208', '0', '0', null, '0');
INSERT INTO `lr_product_dp` VALUES ('10', '5', '273', '109', '8', '东西非常不错，给力！', '1482907790', '0', '0', null, '0');
...
CREATE TABLE `lr_product_sc` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品收藏表';

-- ----------------------------
-- Records of lr_product_sc
-- ----------------------------
INSERT INTO `lr_product_sc` VALUES ('5', '288', '1', '1');
...
CREATE TABLE `lr_program` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='小程序配置';
...
CREATE TABLE `lr_sccat` (
  ...
  `shop_id` int(11) unsigned DEFAULT '0' COMMENT '店铺id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='店铺';
...
CREATE TABLE `lr_search_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='搜索记录表';
...
INSERT INTO `lr_search_record` VALUES ('19', '1', '狗粮', '3', '1495781789');
INSERT INTO `lr_search_record` VALUES ('20', '1', '模拟', '1', '1510492145');
...
CREATE TABLE `lr_shangchang` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商场   第三方小程序关联管理表';
...
CREATE TABLE `lr_shangchang_dp` (
  ...
  `audit` tinyint(2) NOT NULL DEFAULT '0' COMMENT '审核状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='第三方店铺收藏表';
...
CREATE TABLE `lr_shangchang_sc` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='第三方商场收藏表';
...
CREATE TABLE `lr_student_style` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '文章内容',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='文章内容';
...
CREATE TABLE `lr_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户表：包括后台管理员、商家会员和普通会员';
...
CREATE TABLE `lr_user_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='课程报名表';
...
CREATE TABLE `lr_user_voucher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='会员优惠券领取记录';
...
CREATE TABLE `lr_voucher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='优惠券';
...
CREATE TABLE `lr_web` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='地图连接';
